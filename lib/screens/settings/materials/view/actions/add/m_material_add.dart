...
class SetMaterialsMaterialAdd extends StatefulWidget {
  const SetMaterialsMaterialAdd({Key? key, required this.code,required this.id}) : super(key: key);
  final String code;
  final int id;
  @override
  SetMaterialsMaterialAddState createState() => SetMaterialsMaterialAddState();
}

class SetMaterialsMaterialAddState extends State<SetMaterialsMaterialAdd>
    with SingleTickerProviderStateMixin {
  final _formKey = GlobalKey<FormBuilderState>();
  late FutureService futureService;
  final url = "materials/add";
  // ignore: unused_field
  @override
  void initState() {
    super.initState();
