...
class SetMaterialGroupAdd extends StatefulWidget {
  const SetMaterialGroupAdd({Key? key, required this.code,required this.id}) : super(key: key);
  final String code;
  final int id;
  @override
  SetMaterialGroupAddState createState() => SetMaterialGroupAddState();
}

class SetMaterialGroupAddState extends State<SetMaterialGroupAdd>
    with SingleTickerProviderStateMixin {
  final _formKey = GlobalKey<FormBuilderState>();
  late FutureService futureService;
  final url = "materials/group/add";
  // ignore: unused_field
  @override
  void initState() {
    super.initState();
