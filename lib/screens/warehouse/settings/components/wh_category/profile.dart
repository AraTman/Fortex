...
class WhCategoryProfile extends StatefulWidget {
  WhCategoryProfile({Key? key, required this.id}) : super(key: key);
  late int id;
  @override
  WhCategoryProfileState createState() => WhCategoryProfileState();
}

class WhCategoryProfileState extends State<WhCategoryProfile>
  ...
  void initState() {
    ...
    httpWhCategory = futureService.getHttpWhCategoryGets(welPath, widget.id);
  }
