...
class WhLocalizationSizeProfile extends StatefulWidget {
  WhLocalizationSizeProfile({Key? key, required this.id}) : super(key: key);
  late int id;
  @override
  WhLocalizationSizeProfileState createState() => WhLocalizationSizeProfileState();
}

class WhLocalizationSizeProfileState extends State<WhLocalizationSizeProfile>
    with SingleTickerProviderStateMixin {
  final FocusNode myFocusNode = FocusNode();
  bool isLoading = false;
  late IFutureService futureService;
  late Future<List<WhModelList>> httpWh;
  final welPath = "warehouse/localization/size/get";
  bool _status = false;
  @override
  void initState() {
    super.initState();
