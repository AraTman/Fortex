...
class WhProfile extends StatefulWidget {
  WhProfile({Key? key, required this.id}) : super(key: key);
  late int id;
  @override
  WhProfileState createState() => WhProfileState();
}

class WhProfileState extends State<WhProfile>
    with SingleTickerProviderStateMixin {
  final FocusNode myFocusNode = FocusNode();
  bool isLoading = false;
  late IFutureService futureService;
  late Future<List<WhModelList>> httpWh;
  final welPath = "warehouse/get";
  bool _status = false;
  @override
  void initState() {
    super.initState();
