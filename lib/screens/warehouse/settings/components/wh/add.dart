...
class WhAdd extends StatefulWidget {
  const WhAdd({Key? key, required this.id,required this.code}) : super(key: key);
  final int id;
  final String code;
  @override
  WhAddState createState() => WhAddState();
}

class WhAddState extends State<WhAdd> with SingleTickerProviderStateMixin {
  final _formKey = GlobalKey<FormBuilderState>();
  late FutureService futureService;

  final url = "warehouse/add";
  // ignore: unused_field
  @override
  void initState() {
    super.initState();
