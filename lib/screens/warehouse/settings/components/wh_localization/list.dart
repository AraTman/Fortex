...
class WhLocalizationList extends StatefulWidget {
  const WhLocalizationList({Key? key,required this.code}) : super(key: key);
final String code;
  @override
  _WhLocalizationListState createState() => _WhLocalizationListState();
}

class _WhLocalizationListState extends State<WhLocalizationList>
    with AutomaticKeepAliveClientMixin {
  final welPath = "warehouse/localization/list";
        ...
        .map((wh) => _source1.add({
              ...
              'actions': IconButton(
                ...
                onPressed: () => showCupertinoModalBottomSheet(
                  isDismissible: false,
                  context: context,
                  builder: (context) => WhLocalizationProfilPage(
