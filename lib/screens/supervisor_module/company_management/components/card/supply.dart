...
class CardSupplyTable extends StatefulWidget {
  const CardSupplyTable({Key? key}) : super(key: key);

  @override
  _CardSupplyTableState createState() => _CardSupplyTableState();
}

class _CardSupplyTableState extends State<CardSupplyTable>
